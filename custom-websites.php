    ...
    <section class="custom-websites__about">
        ...
        <div class="box-1">
            ...
            <div class="box-2">
                ...
                <span class="pricing">Prices starting at $750</span>
            </div>
        </div>
    </section>
    ...
    <section class="custom-websites__features">
        ...
        <div class="box-1">
            ...
            <div class="box-3">
                ...
                <p>Need to make regular updates to your site? You can take control of nearly any aspect of your site with <a href="evolution.php">Evolution</a> or WordPress. All you need is an Internet connection!</p>
            </div>
        </div>
        <div class="box-1">
            <div class="box-3">
