...
<?php include "includes/navigation.php"; ?>
    ...
    <!-- ===============================
                HEADER
    ================================= -->
    <header class="header_small header_small--tridentPage">
        <div class="header_small__text-box">
                    <h1>Trident</h1>
                    <h2>CL Advantage contact form system</h2>
        </div>
    </header>
    ...
    <!-- =============================
                MAIN HEADING
    =============================== -->
    <section class="TRIDENT__about">
        <h1>connecting with your clients has never been so simple</h1>
        <div class="box-1">
            <div class="box-2">
            ...
            <div class="box-2">
                ...
                <span class="fine-print">*Additional fees for design and installation</span>
            </div>
