...
function get_contacts_info(){
    ...
    $filter_query = "SELECT * FROM contacts_filter";
    $filter_data = mysqli_query($connection, $filter_query);
    $filter_row = mysqli_fetch_assoc($filter_data);
    $filter = $filter_row['filter'];
    $direction = $filter_row['direction'];
    
    $query = "SELECT * FROM contacts ORDER BY $filter $direction";
